...
```javascript
import reSemVer from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-semver@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { REGEXP } from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-semver@v0.2.0-deno/mod.js';
```
